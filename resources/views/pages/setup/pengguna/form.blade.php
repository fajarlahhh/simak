				...
				<div class="row">
					<div class="col-md-5">
						...
						<div class="form-group">
							...
							<input class="form-control" type="text" name="pengguna_hp" value="{{ $aksi == 'Edit'? $data->pengguna_hp: '' }}" required data-parsley-minlength="10" data-parsley-maxlength="16" autocomplete="off" data-parsley-type="number" />
						</div>
						<div class="form-group">
	                        ...
	                        <div class="panel-body row">
								...
								@endphp
									<div class="hakakses checkbox checkbox-css col-md-6 col-lg-4">
										<input type="checkbox" onchange="child('cssCheckbox{{ $i }}')" id="cssCheckbox{{ $i }}" name="izin[]" value="{{ strtolower($menu['title']) }}" {{ ($aksi == 'Edit'? ($data->roles[0]->name == 'admin'? 'checked': ($data->hasPermissionTo(strtolower($menu['title']))? 'checked': '')): '') }}/>
