                ...
                <div class="tab-pane fade" id="default-tab-2">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="edaran_kepada_awal" value="{{ $kepada? $kepada[0]: (old('edaran_kepada_awal')? old('edaran_kepada_awal'): "Kepada Yth :") }}" />
                        </div>
                        <div class="note note-default">
                            ...
                            <table class="table">
                                <tbody id="tujuan">
                                   ...
                                   <tr>
                                       <td>
                                           <select class="form-control opd" name="tujuan[]" style='width: 100%;'>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="edaran_kepada_akhir" value="{{ $kepada? $kepada[2]: (old('edaran_kepada_akhir')? old('edaran_kepada_akhir'): "di Tempat") }}" />
                        </div>
                    </fieldset>
                </div>
                @endif
        ...
        function hapus(id, ket) {
            Swal.fire({
                ...
                if (result.value == true) {
                    $.ajax({
                        url: '{{ url("/edaran/hapus/lampiran") }}?file=' + id,
                        type: "POST",
                        data: {
                            "_method": 'DELETE'
                        },
