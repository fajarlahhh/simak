					...
					<tbody>
					    ...
					    <tr>
                            ...
                            <td class="with-btn-group align-middle" nowrap>
                                <div class="btn-group">
                                    <a href="{{ url('/edaran/cetak?no='.$row->edaran_nomor) }}" target="_blank"" class="btn btn-default btn-sm">Preview</a>
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        ...
                                        @if ($row->fix == 0)
                                        <li>
                                            <a href="{{ url('/edaran/edit?no='.$row->edaran_nomor) }}" class="m-2">
                                                Edit Keseluruhan
                                                @if ($row->harus_revisi)
                                        ...
                                        <li>
                                            <a href="{{ url('/edaran/edit/isi?no='.$row->edaran_nomor) }}" class="m-2"> Edit Isi</a>
                                        </li>
                                        @endif
                                        <li>
