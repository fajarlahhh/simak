...
class KopSuratSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('kop_surat')->insert([
            ...
            <tbody>
                <tr>
                    <td style="text-align:center"><img alt="" src="/uploads/gambar/logo_ntb.png" style="height:148px; width:100px" /></td>
                    <td style="text-align:center">
                    <p><span style="font-size:20px"><strong><span style="font-family:Times New Roman,Times,serif">PEMERINTAH PROVINSI NUSA TENGGARA BARAT</span></strong></span></p>

                    <p><span style="font-size:20px"><strong><span style="font-family:Times New Roman,Times,serif">DINAS PENDIDIKAN DAN KEBUDAYAAN</span></strong></span></p>
